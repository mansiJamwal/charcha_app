                ...
                <div className="flex justify-around bg-gradient-to-b from-black to-gray-800 w-full  h-full items-center">
                    <div className="flex flex-col  gap-5  m-4 my-8">
                        ...
                        <div className="user flex items-center gap-4">
                            ...
                            <select name='user' id='user' className='  bg-black p-2  border-[0.1px] rounded-[5px] border-opacity-25 border-white ' >
                        ...
                        <div className="category flex items-center gap-4">
                            ...
                            <select name='category' id='category' className='  bg-black p-2  border-[0.1px] rounded-[5px] border-opacity-25 border-white'>
                                <option value="entertainment">Entertainment</option>
                            </select>
                        </div>
                        <div className="calendar flex items-center gap-4">
                            <label htmlFor="date">Date:</label>
                            <input className='bg-white p-2  border-[0.1px] rounded-[5px] border-opacity-25 text-black border-white'type="date" id="date" name="date" />
                        </div>
...
function PostComponent(props: PostInputs) {
    return (
        <li className=" rounded-[8px] w-full relative  flex items-center p-5 border border-white border-opacity-10 hover:border-opacity-75 min-h-[150px]">
            ...
            <div className="user absolute top-0 left-0 m-6">{props.username}</div>
            <div className="date absolute top-0 right-0 m-6">{props.sent_time}</div>
            {/* </div> */}
