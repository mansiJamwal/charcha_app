...
const LandingPage = () => {
  return (
    <main className="h-screen bg-gradient-to-bl from-black to-gray-900 flex gap-[20px] flex-col items-center justify-center text-white ">
        ...
        <div className="w-[70%] text-center text-xl text-gray-200">This is a social media application, where you can interact with the all the Users on this Platform.
